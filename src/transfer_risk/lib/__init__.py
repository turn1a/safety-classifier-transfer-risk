...
(:mod:`~transfer_risk.lib.thresholds`), plus surrogate-level association
statistics (:mod:`~transfer_risk.lib.association`). These functions are
unit-tested in isolation and reused by the Kedro pipeline nodes.
